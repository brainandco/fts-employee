    ...
    <div className="space-y-6">
      ...
      <header className="rounded-2xl border border-teal-200 bg-gradient-to-r from-teal-50 to-cyan-50 p-5 sm:p-6">
        ...
        <p className="mt-1 text-sm text-zinc-600">
          Leave applications from DT and Driver/Rigger on teams you lead (same region and project as your assignment, or where you are set as Post Processor
          on the team). Admin and super user still approve the workflow.
        </p>
      ...
      {list.length === 0 ? (
        <p className="rounded-xl border border-zinc-200 bg-white p-6 text-sm text-zinc-600">
          No leave requests from your team members yet, or none you can see. Ensure your region and project match the team in Admin.
        </p>
      ) : (
