import { resolvePmPpReportsFolderZip } from "@/lib/pp-reports/folder-zip";
import {
...
export async function POST(req: Request) {
  ...
  const publicUrl = `${origin}/api/pm/pp-reports/folder-zip/public?t=${encodeURIComponent(token)}`;
