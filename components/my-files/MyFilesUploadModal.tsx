...
export function MyFilesUploadModal({
  open,
  step,
  kind,
  folderName,
    ...
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      >
        <div className="border-b border-zinc-100 px-5 py-4">
          <h2 id="upload-modal-title" className="text-lg font-semibold text-zinc-900">
          ...
          {kind === "folder" && folderName ? (
            <p className="mt-1 text-xs text-zinc-600">
              Folder from your computer: <strong className="text-zinc-900">{folderName}</strong> — {totalFiles} file(s) to
              upload
            </p>
          ) : (
            <p className="mt-1 text-xs text-zinc-600">
